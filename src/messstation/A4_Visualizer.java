...
public class A4_Visualizer {

	public static void main(String[] args) {
		// 6x (= 'util.MessstationDummy.getSENSOR_TYPES().length')
		Messwertanalyse();
		Messwertanalyse();
		Messwertanalyse();
		Messwertanalyse();
	...
	public static void Messwertanalyse() {
		...
		if (Fehlererkennung(field_f) && Checksum.verifyChecksum(messung.substring(0,messung.length()-1), field_c)){ // in verifyChecksum wird das letzte Zeichen nicht übergeben
